...
<tr><td></td><td><br><br><br><br><input type=submit value="SendMail" class="myButton">&nbsp;&nbsp;&nbsp;&nbsp;<input type=reset value="Reset" class="myButton">&nbsp;&nbsp;&nbsp;&nbsp;<a href="inbox.jsp"><input type=button value="Back" class="myButton"></a></td></tr>
