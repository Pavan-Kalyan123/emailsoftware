...
<form name="f1" method="GET" action="checkinboxdelete.jsp">
<table border=0 width="90%" align=center><tr><td align=center><a href="inbox.jsp">Inbox</a></td><td align=center><a href="SentBox.jsp">Sentbox</a></td><td align=center><a href="ComposeMail.jsp">ComposeMail</a></td><td align=center><a href="logout.jsp">Logout</a></td></tr></table><br><br>
...
<td align=center><input type=checkbox class="myCheckBox" name="myCheckbox" value=<%=mid%>></td>

</tr><%
}
%>
</table><input type="hidden" name="mnext" value=1>
</form>
<%
connection.close();
} catch (Exception e) {
